...
public class Mynotessubjectsactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mynotessubjectsactivity);
...
//        mToolbar.setTitle("My Notes");
        ...
        listAdapter = new MyListAdapter(Mynotessubjectsactivity.this, SectionList);
