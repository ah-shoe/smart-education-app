...
public class MyStartAssessmentactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_start_assessmentactivity);
...
//        mToolbar.setTitle("My Notes");
        ...
        listAdapter = new ListAdapter3(MyStartAssessmentactivity.this, SectionList);
