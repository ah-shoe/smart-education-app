...
/**
 * Created by Animesh Jain on 03/03/2020.
 */
...
public class ListAdapter3  extends BaseExpandableListAdapter {
    ...
    public ListAdapter3(Context context, ArrayList<HeaderInfo> deptList) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        if (view == null) {
            ...
            view = infalInflater.inflate(R.layout.child4_row, null);
        }
