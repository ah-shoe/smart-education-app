...
public class MyListAdapter3 extends BaseExpandableListAdapter {

    private Context context;
    private ArrayList<HeaderInfo> deptList;

    public MyListAdapter3(Context context, ArrayList<HeaderInfo> deptList) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        if (view == null) {
            ...
            view = infalInflater.inflate(R.layout.child_row3, null);
        }
