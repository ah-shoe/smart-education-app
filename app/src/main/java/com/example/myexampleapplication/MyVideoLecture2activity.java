...
public class MyVideoLecture2activity extends AppCompatActivity {
...
//        mToolbar.setTitle("My Notes");
        toolbarTop.setBackgroundColor(getResources().getColor(R.color.my_video_lectures));
        ...
        listAdapter = new MyListAdapter3(MyVideoLecture2activity.this, SectionList);
